...
struct Solve1: ParsableCommand {
  static let configuration = CommandConfiguration(
    abstract: "Execute the solution to part 1 of the 2020 day 4 Advent of Code challenge",
    subcommands: []
  )
  ...
  private func solve(passports: [Passport]) -> Int {
    ...
    return passports.filter(\.hasRequiredFields).count
  }
